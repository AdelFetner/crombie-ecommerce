        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtotal = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, computedColumnSql: "[Quantity] * [Price]"),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Address", "Email", "Image", "IsVerified", "Name", "Password", "RoleId" },
                values: new object[,]
                {
                    { new Guid("3d4a7c9f-2e1b-4a8d-9c3f-6b2e1d0a4c7b"), "La casa de los olmedo", "alex.j@example.com", "user-alex.jpg", true, "Alex Johnson", "SecurePass123!", 1 },
                    { new Guid("5b3d9f1a-7e2c-48d9-9a1b-4f6c3e2d0a5b"), "321 Elm St, Bookville", "liam.b@example.com", "user-liam.jpg", true, "Liam Brown", "L1amBrown!", 1 }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Address", "Email", "Image", "Name", "Password", "RoleId" },
                values: new object[,]
                {
                    { new Guid("8c2d1f9a-4b3e-4567-8910-3f6e5d4c2b1a"), "Palito Santo 2040", "emma.w@example.com", "user-emma.jpg", "Emma Wilson", "Emm@2024!", 1 },
                    { new Guid("a1b8f45c-9d32-4e67-82f1-0c3d5e7f9a2b"), "123 Main St, TechCity", "maria.g@example.com", "user-maria.jpg", "Maria Gomez", "MariaG0mez!", 1 },
                    { new Guid("e6f9d287-5c34-4a1b-89d0-3b7a2c4e5f1a"), "456 Oak St, MetroCity", "john.d@example.com", "user-john.jpg", "John Doe", "DoeJ0hn!", 1 }
                });
